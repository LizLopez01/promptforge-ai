...
TEXTS = {
    "Español": {
        ...
        "warning_profession": "⚠️ Por favor ingresa tu profesión primero.",
        "why_label": "💡 ¿por qué aprender prompt engineering?",
        "why_1_title": "Habilidad #1 emergente",
        "why_1_desc": "WEF 2025 y Forrester 2026: la skill más demandada.",
        "why_2_title": "Ejercicios de tu trabajo real",
        "why_2_desc": "La IA genera situaciones de tu profesión específica.",
        "why_3_title": "Sube de nivel automáticamente",
        "why_3_desc": "Básico → Intermedio → Avanzado según tu progreso.",
        ...
        "new_ex_btn": "🔄 Nuevo ejercicio",
        "tips_label": "🎯 tips para un buen prompt",
        "tip_1_title": "Sé específico", "tip_1_desc": "Define exactamente qué quieres.",
        "tip_2_title": "Da contexto", "tip_2_desc": "Explica quién eres y para qué.",
        "tip_3_title": "Define el tono", "tip_3_desc": "Formal, técnico, simple...",
        "tip_4_title": "Pide formato", "tip_4_desc": "Lista, tabla, párrafo, pasos...",
        "session_label": "📊 sesión actual",
        "done_label": "Hechos", "avg_label": "Promedio", "level_label": "Nivel",
        "spinner_ex": "✨ Generando tu ejercicio personalizado...",
        "spinner_eval": "🤖 Analizando tu prompt...",
        "spinner_rw": "🪄 Mejorando tu prompt...",
        "error_connect": "❌ Error al conectar:",
        "eval_section": "evaluación de tu prompt",
        "improve_lbl": "⚠ Qué mejorar", "suggest_lbl": "💡 Sugerencia", "good_lbl": "✅ Lo que hiciste bien",
        "rewrite_btn": "✨ Reescribir con IA",
        "next_btn": "➡️ Siguiente ejercicio",
        "progress_btn": "📊 Ver mi progreso",
        "rewrite_hdr": "✨ Versión mejorada por IA",
        "orig_lbl": "Tu prompt original", "improved_lbl": "Versión mejorada",
        "progress_label": "📊 resumen de tu sesión",
        "exercises_lbl": "Ejercicios", "best_lbl": "Mejor puntaje", "level_curr": "Nivel actual",
        "history_lbl": "🕐 historial",
        "export_btn": "⬇️ Exportar JSON",
        "clear_btn": "🗑️ Limpiar historial",
        "continue_btn": "🚀 Seguir practicando",
        "empty_history": "🎯 Completa tu primer ejercicio para ver el historial aquí.",
